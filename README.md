# V0.3
версия 0.3 официально вышла! вы уже можете наслаждаться моим шедевро-скриптом
остальные версии у меня в ДС, ссылка: https://discord.gg/Wx3sx8xJWg
# изменения v0.3
- исправлен баг с ключом из-за которого скрипт не запускался
- добавлен протект античита
